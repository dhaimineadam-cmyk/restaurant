  ...
  return (
    <header className="sticky top-0 z-50 bg-white/95 backdrop-blur shadow-sm border-b border-amber-100">
      <div className="mx-auto flex max-w-7xl items-center justify-between px-4 py-4 sm:px-6 lg:px-8">
        <NavLink to="/" className="flex items-center gap-x-3 text-amber-900">
        ...
        <div className="hidden lg:flex lg:items-center lg:gap-x-4">
          <div className="flex flex-wrap items-center gap-2">
            ...
            <div className="relative">
              ...
              {categoryOpen && (
                <div className="absolute right-0 z-20 mt-2 w-56 overflow-hidden rounded-3xl border border-amber-100 bg-white shadow-lg ring-1 ring-black ring-opacity-5">
                  {categories.length === 0 ? (
      ...
      <div className={`lg:hidden ${mobileOpen ? 'block' : 'hidden'} border-t border-amber-100 bg-white/95`}> 
        <div className="space-y-1 px-4 py-4">
          ...
          <div className="rounded-3xl border border-amber-100 bg-amber-50 p-3">
            ...
            >
              ...
              <span className={`transition-transform duration-200 ${categoryOpen ? 'rotate-180' : ''}`}>
                ▼
              </span>
            </button>
            {categoryOpen && (
